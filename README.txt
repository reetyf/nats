...
Firstly, the answers to the long-form questions 1-4 are located in the corresponding Jupyter Notebook visible on my github repository for this project (https://github.com/reetyf/nats/blob/main/hweinschenk_nats_r_and_d_Q1-4.ipynb). The logic for data creation, as well as the actual .csv generation is in the 'Q5' notebook (https://github.com/reetyf/nats/blob/main/hweinschenk_nats_r_and_d_Q5.ipynb).
